...
class MonItApp(ctk.CTk):
    ...
    def register_hotkey(self):
        ...
        try:
            ...
            pass
        try:
            keyboard.add_hotkey(self.block_hotkey, self.block_secondary_display)
            keyboard.add_hotkey(self.unblock_hotkey, self.unblock_secondary_display)
    ...
    def open_hotkey_popup(self, key_type, label_to_update):
        ...
        info = ctk.CTkLabel(popup, text="Press new hotkey...", font=("Segoe UI", 14))
        info.pack(pady=20)
